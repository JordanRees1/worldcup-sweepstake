...
export function GroupsScreen() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-xs font-medium uppercase tracking-wide text-slate-400">Group standings</h2>
            ...
            {group.rows.map((row) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="w-6 text-center tabular-nums text-slate-400">{row.played}</span>
